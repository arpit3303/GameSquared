...
const Board = () => {
  const { columns, addCard, addColumn, updateCardStatus, updateColumnOrder } =
    useBoard() || {};
    ...
    <>
      <div className="app-header">
        ...
        <p className="app-heading">
          Add todos with the add card button - by default it gets added to the
          first column
        </p>
        <p className="app-heading">
          Add more columns with the App Column button and re-arange based on
          your workflow.
        </p>
      </div>
      ...
      <div className="app-actions">
        ...
        {columns.length && (
          <Button type="primary" onClick={() => handleAddCard(columns[0].id)}>
            Add Card
          </Button>
        )}
      </div>
